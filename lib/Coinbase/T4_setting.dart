import 'setting_layout/T4_aboutApps.dart';
import 'setting_layout/T4_callCenter.dart';
import 'setting_layout/T4_message.dart';
import 'setting_layout/T4_notification.dart';
import 'setting_layout/T4_payment.dart';
import 'setting_layout/T4_setting_account.dart';
        ...
        child: Column(
          children: <Widget>[
            ...
            category(
              txt: "Notification",
              padding: 35.0,
              image: "lib/Coinbase/Assets/notification.png",
              tap: () {
            ...
            category(
              txt: "Payments",
              padding: 35.0,
              image: "lib/Coinbase/Assets/creditAcount.png",
              tap: () {
                Navigator.of(context).push(PageRouteBuilder(
            ...
            category(
              txt: "Message",
              padding: 26.0,
              image: "lib/Coinbase/Assets/chat.png",
              tap: () {
                Navigator.of(context).push(PageRouteBuilder(
            ...
            category(
              txt: "Setting Acount",
              padding: 30.0,
              image: "lib/Coinbase/Assets/setting.png",
              tap: () {
                Navigator.of(context).push(PageRouteBuilder(
            ...
            category(
              txt: "Call Center",
              padding: 30.0,
              image: "lib/Coinbase/Assets/callcenter.png",
              tap: () {
                Navigator.of(context).push(PageRouteBuilder(
            ...
            category(
              padding: 38.0,
              txt: "About Apps",
              image: "lib/Coinbase/Assets/aboutapp.png",
              tap: () {
                Navigator.of(context).push(PageRouteBuilder(
