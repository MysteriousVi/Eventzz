...
const String defaultUserName = "Lana Fox";

class T4_chatItem1 extends StatefulWidget {
  T4_chatItem1({Key? key}) : super(key: key);

  _T4_chatItem1State createState() => _T4_chatItem1State();
}

class _T4_chatItem1State extends State<T4_chatItem1>
                ...
                new Flexible(
                  child: _messages.length > 0
                    ...
                    child: new ListView.builder(
                      ...
                      reverse: true,
                      padding:
                      new EdgeInsets.only(right: 10.0, bottom: 10.0),
                    ),
                  )
                      : NoMessage(),
                ),
          ...
          child: new Row(
            children: <Widget>[
              IconButton(
                ...
                onPressed: () => _submitMsg('Vcard Sent!!!!!'),
              ),
              new Flexible(
                child: Padding(
