...
class T4_leaderboard extends StatefulWidget {
  T4_leaderboard({Key? key}) : super(key: key);

  _T4_leaderboardState createState() => _T4_leaderboardState();
}

class _T4_leaderboardState extends State<T4_leaderboard> {
  var data  ;

  get_data() async {
    data = await get_leaderpoints();
    setState(() {});
  }
